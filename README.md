# AI Learn 01 — Sinusoidal Positional Encoding from Scratch

First project in the **ai-learn-*** series. Transformers have no recurrence and no convolution — without **positional encoding**, a bag of token embeddings cannot tell *where* each token sat.
